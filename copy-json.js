/**
 * Copy JSON configuration files to dist folder. Also copies the folder structure of the given source directory if it
 * contains JSON files.
 * NOTE: This script only copies new and rewrites existing files, it does not remove obsolete files or folders from
 * dist.
 */
const fs = require('fs')
